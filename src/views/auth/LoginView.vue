  ...
  <div class="card bg-base-100 shadow-xl">
    <div class="card-body">
      ...
      <div class="space-y-4">
        ...
        <button class="btn btn-primary btn-block" :class="{ 'loading': loading }" :disabled="loading" @click="handleLogin">Log In</button>
      </div>

      <div class="text-center mt-4 space-y-2">
        <RouterLink to="/signup" class="link link-primary text-sm block">Don't have an account? Sign up</RouterLink>
        <RouterLink to="/teacher-signup" class="link link-secondary text-sm block">Teacher? Sign up here</RouterLink>
      </div>
    </div>
  </div>
</template>
