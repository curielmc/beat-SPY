      ...
      <div class="card bg-base-100 shadow-sm">
        <div class="card-body p-4 space-y-4">
          <h2 class="font-bold text-base flex items-center gap-2">
            ...
            Aggregate Sector Exposure — All Groups
          </h2>
      ...
      <div class="card bg-base-100 shadow-sm">
        <div class="card-body p-4 space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <h2 class="font-bold text-base flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-info" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0012 18.75c-.93 0-1.77-.375-2.38-.98l-.547-.547z" /></svg>
                AI Thesis Rankings
              </h2>
