  ...
  <div class="space-y-6">
    ...
    <div class="card bg-base-100 shadow">
      <div class="card-body p-4">
        <div class="flex items-center justify-between flex-wrap gap-2">
          <h2 class="font-bold text-lg">SPY Performance</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div class="lg:col-span-2">
        <h2 class="font-bold text-lg mb-3">Sector Breakdown</h2>
    ...
    <!-- Key Stats -->
    <div>
      <h2 class="font-bold text-lg mb-3">Key Stats</h2>
    ...
    <div class="card bg-base-100 shadow">
      <div class="card-body p-4">
        <div class="flex items-center justify-between flex-wrap gap-2 mb-3">
          <h2 class="font-bold text-lg">All Constituents</h2>
    ...
    <div>
      <h2 class="font-bold text-lg mb-3">How SPY Works</h2>
