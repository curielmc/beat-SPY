...
export async function screenStocks(params = {}) {
  ...
  if (params.priceMoreThan) query.set('priceMoreThan', params.priceMoreThan)
  if (params.priceLowerThan) query.set('priceLowerThan', params.priceLowerThan)
  if (params.volumeMoreThan) query.set('volumeMoreThan', params.volumeMoreThan)
  if (params.volumeLowerThan) query.set('volumeLowerThan', params.volumeLowerThan)
  if (params.exchange) query.set('exchange', params.exchange)
  if (params.country) query.set('country', params.country)
  if (params.dividendMoreThan != null) query.set('dividendMoreThan', params.dividendMoreThan)
  if (params.dividendLowerThan != null) query.set('dividendLowerThan', params.dividendLowerThan)
  ...
  if (params.isActivelyTrading !== undefined) query.set('isActivelyTrading', params.isActivelyTrading)
