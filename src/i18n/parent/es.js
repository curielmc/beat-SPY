export default
{
  ...
  "page": {
    ...
    "parent_copy_optin": "Envíenme copias de los correos importantes (registro, resultados, pagos)",
    "parent_phone": "Su teléfono (opcional, para SMS)",
    "success": "Gracias. {student_name} ahora puede participar en beat-SPY.",
    "expired": "Este enlace de consentimiento ha caducado. Pídale a {student_name} que solicite uno nuevo.",
    "used": "Este enlace de consentimiento ya ha sido utilizado.",
    "legal_links_intro": "Revise nuestras políticas:",
